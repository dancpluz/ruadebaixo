...
${cpf ? `📃 ${cpf}\n` : ''}💳 Tipo de Pagamento: ${payment}`
  ...
  await emailjs.send('service_rdb','template_rdb-venda',{ email: 'contato@ruadebaixo.com.br, dan08jan@gmail.com',id,message },{ publicKey: process.env.EMAILJS_TOKEN } ).then(
      (response) => {
