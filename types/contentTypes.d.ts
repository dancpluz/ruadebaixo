...
export interface ApiClientClient extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    asaas_user_id: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    info: Schema.Attribute.Component<'checkout.client-info', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::client.client'
    ...
    order_stores: Schema.Attribute.Relation<
      'oneToMany',
      'api::order-store.order-store'
    >;
    publishedAt: Schema.Attribute.DateTime;
    thrift_orders: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiDropDrop extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::drop.drop'> &
      Schema.Attribute.Private;
    lookbook: Schema.Attribute.Relation<'oneToOne', 'api::lookbook.lookbook'>;
    publishedAt: Schema.Attribute.DateTime;
    seller: Schema.Attribute.Relation<'manyToOne', 'api::seller.seller'>;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    store_products: Schema.Attribute.Relation<
      'oneToMany',
      'api::product-store.product-store'
    >;
    thrift_products: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiGeneralGeneral extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    links: Schema.Attribute.Component<'link.link', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::general.general'
    ...
    maintenance: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    maintenance_text: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiOrderStoreOrderStore extends Struct.CollectionTypeSchema {
  collectionName: 'order_stores';
  info: {
    description: '';
    displayName: 'Vendas Loja';
    pluralName: 'order-stores';
    singularName: 'order-store';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    asaas_payment_id: Schema.Attribute.String;
    cart_items: Schema.Attribute.JSON;
    checkout: Schema.Attribute.Component<'checkout.checkout', false>;
...
export interface ApiOrderThriftOrderThrift extends Struct.CollectionTypeSchema {
  collectionName: 'order_thrifts';
  info: {
    description: '';
    displayName: 'Vendas Brech\u00F3';
    pluralName: 'order-thrifts';
    singularName: 'order-thrift';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiProductStoreProductStore
  extends Struct.CollectionTypeSchema {
  collectionName: 'product_stores';
  info: {
    description: '';
    displayName: 'Produtos Loja';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    drop: Schema.Attribute.Relation<'manyToOne', 'api::drop.drop'>;
    images_3d: Schema.Attribute.Media<'images', true> &
      Schema.Attribute.Required;
    images_banner: Schema.Attribute.Media<'images', true> &
      Schema.Attribute.Required;
    images_packaging: Schema.Attribute.Media<'images', true>;
    info: Schema.Attribute.Component<'product.product-info', false> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    main_variant: Schema.Attribute.Component<'product.variant', true> &
      Schema.Attribute.Required;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    seller: Schema.Attribute.Relation<'manyToOne', 'api::seller.seller'>;
...
export interface ApiProductThriftProductThrift
  extends Struct.CollectionTypeSchema {
  collectionName: 'product_thrifts';
  info: {
    description: '';
    displayName: 'Produtos Brech\u00F3';
    pluralName: 'product-thrifts';
    singularName: 'product-thrift';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    main_variant: Schema.Attribute.Component<'product.variant', false> &
      Schema.Attribute.Required;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    seller: Schema.Attribute.Relation<'manyToOne', 'api::seller.seller'>;
...
export interface ApiSellerSeller extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    drops: Schema.Attribute.Relation<'oneToMany', 'api::drop.drop'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::seller.seller'
...
export interface ApiTableTable extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::table.table'> &
      Schema.Attribute.Private;
    measures: Schema.Attribute.Component<'product.measure', true> &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::product-thrift.product-thrift': ApiProductThriftProductThrift;
